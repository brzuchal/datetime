...
class DateTimeDeltaTest extends TestCase
{
    ...
    {
        $delta = DateTimeDelta::parse('P1Y2M3DT4H5M6.789S');
    ...
    {
        $delta = DateTimeDelta::parse('PT1H');
    ...
    {
        $d1 = DateTimeDelta::parse('P1YT1H');
        $d2 = DateTimeDelta::parse('P1MT1M');
        $result = $d1->plus($d2);
    ...
    {
        $d1 = DateTimeDelta::parse('P2Y2M2DT2H2M2S');
        $d2 = DateTimeDelta::parse('P1Y1M1DT1H1M1S');
        $result = $d1->minus($d2);
