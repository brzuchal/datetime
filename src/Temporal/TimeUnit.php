...
final class TimeUnit
{
    ...
    public const int NANOS_PER_MINUTE = 60 * self::NANOS_PER_SECOND;
    public const int NANOS_PER_HOUR = 60 * self::NANOS_PER_MINUTE;
    public const int NANOS_PER_DAY = 24 * self::NANOS_PER_HOUR;
